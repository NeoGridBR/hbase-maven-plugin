...
public class StartMojo extends AbstractMojo {
   ...
   *
   * @parameter property="hbaseSiteFile" default-value="${project.build.testOutputDirectory}/hbase-site.xml"
   * @required
   */
   ...
   *
   * @parameter property="separateConfigurationFiles" default-value="true"
   */
   ...
   *
   * @parameter property="coreSiteFile" default-value="${project.build.testOutputDirectory}/core-site.xml"
   * @required
   */
   ...
   *
   * @parameter property="writeConfIndex" default-value="false"
   */
   ...
   *
   * @parameter property="hbaseConfIndex" default-value="${project.build.testOutputDirectory}/conf-index.conf"
   */
